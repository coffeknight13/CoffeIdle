document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePrestigeCostDisplay() {
        const nextPrestigeCost = getPrestigeCost(playerTotalPrestige);
    ...
    function updatePrestigePointsDisplay() {
        ...
        if (prestigePointsDisplayElement) {
            prestigePointsDisplayElement.textContent = playerPrestige;
        }
    }
    function updatePrestigeTotalDisplay() {
        ...
        if (prestigeTotalDisplayElement) {
            prestigeTotalDisplayElement.textContent = playerTotalPrestige;
        }
    }
    ...
    function resetUpgrades() {
        ...
        if (upgradesListContainer) {
            ...
            researchedSpans.forEach(span => {
                ...
                researchButton.addEventListener('click', function() {
                    ...
                    if (upgrade && !upgrade.researched && playerPrestige >= upgrade.cost) {
                        playerPrestige -= upgrade.cost;
        ...
        coffeeTypes.forEach(updateCoffeeUI);
    }
    ...
    if (prestigeModalButton) {
        prestigeModalButton.addEventListener('click', function() {
            const currentPrestigeCost = getPrestigeCost(playerTotalPrestige);

            if (typeof playerMoney !== 'undefined' && playerMoney >= currentPrestigeCost) {
                playerMoney -= currentPrestigeCost;
                playerPrestige++;
                playerTotalPrestige++;
