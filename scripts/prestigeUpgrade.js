document.addEventListener('DOMContentLoaded', function() {
    ...
    function buyPrestigeUpgrade(upgradeId) {
        ...
        // Перевірка, чи покращення доступне для покупки (враховуючи залежності)
        ...
        if (window.playerPrestige >= upgrade.cost) {
            ...
            if (typeof window.applyUpgradeEffect === 'function') {
                window.applyUpgradeEffect(upgrade.id);
            }
                ...
                button.addEventListener('click', function() {
                    ...
                    if (isPrestigeUpgradeAvailable(upgradeObject)) {
                        if (playerPrestige >= upgradeObject.cost) {
                            ...
                            window.applyUpgradeEffect(upgradeObject)
                            updatePrestigeDisplay();
                            renderUpgrades();
                        }
                    }
    ...
    function isUpgradeRequirementsMet(upgrade) {
        ...
        // Перевірка, чи всі батьківські покращення (за їхніми ID) були досліджені
    ...
    function isPrestigeUpgradeAvailable(upgrade) {
        ...
        // Перевірка, чи виконані всі попередні вимоги (батьківські покращення)
